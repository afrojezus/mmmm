		...
		<div className={styles.wrapper}>
			...
			<dialog ref={dialogRef}>
				<div className={styles.details}>
					...
					<p>
						Analytics is used to track down the performance of the
						site and to understand how users interact with it.
					</p>
					<p>
						If you choose not to consent, the site will not track
